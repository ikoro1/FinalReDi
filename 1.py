...
parser.add_argument('-m', '--model', default='resnet50', choices=['resnet50', 'vgg16', 'mobilenet'])
...
def index():
    if request.method == 'POST':
        ...
        if file:
            ...
            return render_template('index.html', result=f"Prediction: {processed_preds[0][0][1]}")
